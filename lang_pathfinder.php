...
$pf_ja = [
    ...
    // v7.3.7: 段階的遺伝子組み合わせ
    'pf_phase_combine_desc_2gene' => 'フェーズ1の異なる系統から個体を交配し、両方の遺伝子を持つ子を得ます',
    'pf_combine_two_lines' => '2系統を交配',
    'pf_from_pairing_1' => 'ペア1から（{gene}スプリット）',
    'pf_from_pairing_2' => 'ペア2から（{gene}スプリット/発現）',
    'pf_from_pairing_3' => 'ペア3から（{gene}スプリット/発現）',
    'pf_some_have_both' => '子の一部が{genes}両方を保有',
    'pf_phase_combine_step1' => '第1段階：2遺伝子の組み合わせ',
    'pf_phase_combine_desc_first' => 'まず2つの系統を交配し、2遺伝子を持つ個体を作出します',
    'pf_combine_first_two' => '最初の2系統を交配',
    'pf_some_have_two' => '子の一部が{gene1}+{gene2}を保有',
    'pf_phase_combine_step2' => '第2段階：3つ目の遺伝子を追加',
    'pf_phase_combine_desc_third' => '2遺伝子個体に3つ目の系統を交配します',
    'pf_add_third_gene' => '3つ目の遺伝子を追加',
    'pf_with_two_genes' => '{gene1}+{gene2}スプリット',
    'pf_some_have_all' => '子の一部が全遺伝子({genes})を保有',
    'pf_final_cross' => '最終交配',
...
$pf_en = [
    ...
    // v7.3.7: Step-by-step gene combining
    'pf_phase_combine_desc_2gene' => 'Cross birds from different Phase 1 lines to get offspring with both genes',
    'pf_combine_two_lines' => 'Cross two lines',
    'pf_from_pairing_1' => 'From pairing 1 ({gene} split)',
    'pf_from_pairing_2' => 'From pairing 2 ({gene} split/expressing)',
    'pf_from_pairing_3' => 'From pairing 3 ({gene} split/expressing)',
    'pf_some_have_both' => 'Some offspring carry both {genes}',
    'pf_phase_combine_step1' => 'Step 1: Combine First Two Genes',
    'pf_phase_combine_desc_first' => 'Cross two lines to produce birds with 2 genes',
    'pf_combine_first_two' => 'Cross first two lines',
    'pf_some_have_two' => 'Some offspring carry {gene1}+{gene2}',
    'pf_phase_combine_step2' => 'Step 2: Add Third Gene',
    'pf_phase_combine_desc_third' => 'Cross 2-gene birds with the third line',
    'pf_add_third_gene' => 'Add third gene',
    'pf_with_two_genes' => '{gene1}+{gene2} split',
    'pf_some_have_all' => 'Some offspring carry all genes ({genes})',
