...
$pf_ja = [
    ...
    // v7.3.8: フェーズ = 世代の明確化
    'pf_phase_n_intro' => 'フェーズ {n}: 基礎個体の導入',
    'pf_phase_n_combine' => 'フェーズ {n}: 系統の交配',
    'pf_phase_n_add_gene' => 'フェーズ {n}: {gene}の追加',
    'pf_phase_n_final' => 'フェーズ {n}: 目標の作出',
    'pf_combine_two_lines_desc' => '系統1({gene1})と系統2({gene2})を交配し、両遺伝子を持つ個体を作出',
    'pf_cross_lines' => '系統{line1}と系統{line2}を交配',
    'pf_from_line_n' => '系統{n}から（{gene}保有）',
    'pf_some_carry_genes' => '子の一部が{genes}を保有',
    'pf_add_next_gene_desc' => '前世代で作出した個体に{gene}を追加',
...
$pf_en = [
    ...
    // v7.3.8: Phase = Generation clarity
    'pf_phase_n_intro' => 'Phase {n}: Introduce Foundation Stock',
    'pf_phase_n_combine' => 'Phase {n}: Cross Lines',
    'pf_phase_n_add_gene' => 'Phase {n}: Add {gene}',
    'pf_phase_n_final' => 'Phase {n}: Produce Target',
    'pf_combine_two_lines_desc' => 'Cross Line 1 ({gene1}) × Line 2 ({gene2}) to produce birds with both genes',
    'pf_cross_lines' => 'Cross Line {line1} × Line {line2}',
    'pf_from_line_n' => 'From Line {n} ({gene} carrier)',
    'pf_some_carry_genes' => 'Some offspring carry {genes}',
    'pf_add_next_gene_desc' => 'Add {gene} to birds from previous generation',
