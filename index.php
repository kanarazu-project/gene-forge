        ...
        <main>
            ...
            <section id="pathfinder" class="tab-content<?= $activeTab === 'pathfinder' ? ' active' : '' ?>">
                ...
                <div class="output-panel" style="margin-top:1rem;">
                    ...
                    <div style="background:#0097a7;color:#fff;padding:.75rem 1rem;border-radius:8px 8px 0 0;margin-top:1rem;">
                    ...
                    <div style="border:2px solid #0097a7;border-top:none;border-radius:0 0 8px 8px;padding:1rem;background:#1a2332;color:#e0e0e0;">

                        <?php // 必要遺伝子リスト ?>
                        <?php if(!empty($scenario['requiredGenes'])): ?>
                        <div style="margin-bottom:1rem;padding:.5rem;background:#151c28;border-radius:4px;color:#b0bec5;">
                            <strong style="color:#4fc3f7;">🧬 <?= t_pf('pf_required_genes') ?>:</strong>
                    ...
                    <div style="margin-top:1rem;padding:1rem;background:#1a2332;border-radius:8px;border:1px solid #4fc3f7;color:#e0e0e0;">
                        <h4 style="margin:0 0 .75rem 0;color:#4fc3f7;font-size:1.1em;">🔗 <?= t('phase_inference_title') ?></h4>

                        <?php if($hasZPhase): ?>
                        <div style="background:#263238;padding:.75rem;border-radius:6px;margin-bottom:.75rem;">
                            <div style="display:flex;align-items:center;gap:.5rem;margin-bottom:.5rem;">
                                <span style="font-weight:bold;color:#81d4fa;">🧬 <?= t('phase_z_linked') ?></span>
                            </div>
                            <div style="display:grid;grid-template-columns:auto 1fr;gap:.25rem .75rem;font-size:.95em;">
                                <span style="color:#90a4ae;"><?= t('phase_result') ?></span>
                                ...
                                <span style="color:#90a4ae;"><?= t('phase_confidence') ?></span>
                                <span>
                                ...
                                <span style="color:#90a4ae;"><?= t('phase_evidence') ?></span>
                        ...
                        <div style="background:#263238;padding:.75rem;border-radius:6px;">
                            <div style="display:flex;align-items:center;gap:.5rem;margin-bottom:.5rem;">
                                <span style="font-weight:bold;color:#ce93d8;">🧬 <?= t('phase_auto_linked') ?></span>
                            </div>
                            <div style="display:grid;grid-template-columns:auto 1fr;gap:.25rem .75rem;font-size:.95em;">
                                <span style="color:#90a4ae;"><?= t('phase_result') ?></span>
